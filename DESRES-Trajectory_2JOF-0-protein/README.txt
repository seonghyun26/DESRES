...
Simulation of the reversible folding of Trp-cage at 290K (see page 19
of the supplementary materials Lindorff-Larsen et al., Science, 2011).
...
format, and a copy of the license file.  The DCD directory 2JOF-0
contains segments of the trajectory 2JOF-0-nnn.dcd in DCD form.  The
start time in picoseconds for each DCD segment is given in the
2JOF-0/2JOF-0_times.csv file, a comma separated value file that is
...
The 2JOF-0 trajectory dataset is released under the D. E. Shaw
...
directory and use the command:
  ...
  $ vmd 2JOF-0/2JOF-0/*.mae 2JOF-0/2JOF-0-*.dcd
