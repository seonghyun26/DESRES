...
Second of two independent simulations of the reversible folding of BBA
...
format, and a copy of the license file.  The DCD directory 1FME-1
contains segments of the trajectory 1FME-1-nnn.dcd in DCD form.  The
start time in picoseconds for each DCD segment is given in the
1FME-1/1FME-1_times.csv file, a comma separated value file that is
...
The 1FME-1 trajectory dataset is released under the D. E. Shaw
...
directory and use the command:
  ...
  $ vmd 1FME-1/1FME-1/*.mae 1FME-1/1FME-1-*.dcd
