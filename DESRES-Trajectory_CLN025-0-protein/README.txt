...
Simulation of the reversible folding of Chignolin at 340K (see page
18 of the supplementary materials Lindorff-Larsen et al., Science,
2011).
...
format, and a copy of the license file.  The DCD directory CLN025-0
contains segments of the trajectory CLN025-0-nnn.dcd in DCD form.  The
start time in picoseconds for each DCD segment is given in the
CLN025-0/CLN025-0_times.csv file, a comma separated value file that is
...
The CLN025-0 trajectory dataset is released under the D. E. Shaw
...
directory and use the command:
  ...
  $ vmd CLN025-0/CLN025-0/*.mae CLN025-0/CLN025-0-*.dcd
